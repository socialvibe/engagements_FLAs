...
package com.socialvibe.core.utils {
    ...
    public class SWFAddress {
		...
		/**
		 * Pending page (aaron added).
		 */
		public static var pendingPage:String;
		 ...
		 * (aaron added)
		 */
		public static function navigateToPage(page:String):void
		{
			navigateToURL(new URLRequest("#" + page), "_self");
		}
